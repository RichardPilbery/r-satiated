...
Figure \@ref(fig:boxplotint) summarises the intubation attempt times by participants in each randomisation sequence. The time to successful intubation for each attempt, stratified by randomisation sequence can be seen on Table \@ref(tab:summarytime), and 
